...
/**
 * @author Fleyer
 * <p> BoardRflection creation on 29.03.2023 at 13:02
 */
public final class BoardReflection {
    ...
    public static String nmsClassName(String post1_17package, String className) {
        if (NMS_REPACKAGED) {
            val classPackage = post1_17package == null ? NM_PACKAGE : NM_PACKAGE + '.' + post1_17package;
    ...
    public static PacketConstructor findPacketConstructor(Class<?> packetClass, MethodHandles.Lookup lookup) throws Exception {
        ...
        val allocateMethodType = MethodType.methodType(Object.class, Class.class);
        val allocateMethod = lookup.findVirtual(theUnsafe.getClass(), "allocateInstance", allocateMethodType);
